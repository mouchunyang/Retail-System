...
{
    Product* myBook = new Book("book", prodName_, price_, 
        qty_, isbn_, author_ );
    return myBook;
}
...
{
    Product* myClothing = new Clothing("clothing", prodName_, 
        price_, qty_, size_, brand_ );
    return myClothing;
}
...
{
    Product* myMovie = new Movie("movie", prodName_, 
        price_, qty_, genre_, rating_ );
    return myMovie;
}
